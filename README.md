...
Note: MediaMTX is pre-installed and configured. The service will automatically start MediaMTX when it launches. MediaMTX status can be monitored through the web interface at http://localhost:3000.
